			...
			<section class="realms-showcase">
				...
				<div class="realms-grid">
					<div class="realm-card fantasy">
						...
						<a href="/realms/index.php#realm-fantasy" class="realm-link"
							>Explore Fantasy</a
						>
					</div>
					...
					<div class="realm-card science">
						...
						<a href="/realms/index.php#realm-science" class="realm-link"
							>Explore Science</a
						>
					</div>
					...
					<div class="realm-card chaos">
						...
						<a href="/realms/index.php#realm-chaos" class="realm-link"
							>Explore Chaos</a
						>
					</div>
				</div>
