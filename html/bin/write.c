...
status write_graph(string histogram, string usergraph, string weeklist)
{
  ...
  tell_rast( unguarded("html", #'rm, ({ "/html/wholist/histogram.html" }))+"\n" );
  tell_rast( unguarded("html", #'rm, ({ "/html/wholist/usergraph.html" }))+"\n" );
  tell_rast( unguarded("html", #'rm, ({ "/html/wholist/weeklist.html" }))+"\n" );
  ...
  unguarded("html", #'write_file, ({ "/html/wholist/histogram.html", histogram }));
  unguarded("html", #'write_file, ({ "/html/wholist/usergraph.html", usergraph }));
  unguarded("html", #'write_file, ({ "/html/wholist/weeklist.html", weeklist }));
